...
public class JFrameSecundario extends javax.swing.JFrame {
 Productos LosProductos;
  int incre;
    ...
    public JFrameSecundario(Productos datos) {
        initComponents();
        LosProductos=datos;
        incre=0;
    }
    ...
    private void jb3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jb3ActionPerformed
     boolean cap = false;
        cap =LosProductos.setAddInfo(jtCodigo,jtNombre,jtPrecio, jtCantidad,indice);
        if (cap != false) {
            incre++;
            if (incre < LosProductos.length) {
                jl7.setText("Registro de datos "
                        + "del producto en la posición " + incre+ ":");
            } else {
